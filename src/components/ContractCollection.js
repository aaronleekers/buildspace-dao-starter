    ...
    return (
        ...
        <div className='mintCard'>
            <h1>Membership NFT 2022</h1>
                <img className='memberNft' src={'https://bafybeicd42lt7eg56nw6uyce4mzl2tj4vsbnoxgmsgorcnfkl52vt4h45u.ipfs.nftstorage.link/'}/>
      ...
      <div className='mintCard'>
            <h1>Officer NFT 2022</h1>
                <img className='memberNft' src={'https://bafybeicepey3m3eyf5pygpjqveyc3idcz6bh6opvyfsf7xtbb4uezl2dpm.ipfs.nftstorage.link/'}/>
      ...
      <div className='mintCard'>
            <h1>Sittner NFTs 2022</h1>
                <img className='memberNft' src={'https://bafybeicckwd2firzoujztqm4e6c5zceqg6da4rqey6zx2x6k6cximhx4by.ipfs.nftstorage.link/'}/>
